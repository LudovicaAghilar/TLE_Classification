...
OUT_DIR        = r"C:\Users\ludov\Scripts\registered_linear_l\cropped\hist_normed_2\R1\test\HeatMap_avg"
TARGET_LAYER   = "layer4"           # Cambia se necessario
DEVICE         = torch.device("cuda" if torch.cuda.is_available() else "cpu")
ALPHA, FPS     = 0.4, 10
results_dir = r"C:\Users\ludov\Scripts\results\optuna_singolo_R1_resnet18"
...
TEST_TXT_PATH  = r"C:\Users\ludov\Scripts\results\optuna_singolo_R1_resnet18\test_predictions_fold_0.txt"
...
for path in nii_files:
    ...
    try:
        ...
        # Ensemble Grad-CAM: mean of all heatmaps
